...
class ListItemByCategoryRecipe extends StatefulWidget {
  final String categoryName;
  final List<Map<String, dynamic>> data;
  final String prefixDetailPage;

  const ListItemByCategoryRecipe({
    super.key,
  ...
  @override
  State<ListItemByCategoryRecipe> createState() => _ListItemByCategoryRecipeState();
}

class _ListItemByCategoryRecipeState extends State<ListItemByCategoryRecipe> {
  @override
        ...
        (widget.data.isNotEmpty)
            ? ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _listCard(
                    context: context,
                    slug: item['slug'] ?? item['id'], // Use slug if available, fallback to id
                    title: item['title'],
  ...
  return Card(
    child: Padding(
      ...
      child: ListTile(
        ...
        onTap: () {
          GoRouter.of(context).push('$prefixDetailPage/detail/$slug', extra: data);
        },
      ),
    ),
  );
