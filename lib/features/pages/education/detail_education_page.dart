...
class DetailEducationPage extends StatefulWidget {
  ...
  const DetailEducationPage({super.key, required this.id, required this.data});
            ...
            child: Column(
              ...
              children: [
                iconButtonBackWithNamePageWidget(
                  context: context,
                  pageName: "Detail Edukasi",
                ),
                SizedBox(height: AppSizes.base),
                (widget.data['link'] != null &&
                        widget.data['link'].toString().isNotEmpty)
                    ? YoutubePlayerWidget(youtubeUrl: widget.data['link'])
                    : Image.network(
                ...
                SizedBox(height: AppSizes.base),
                Text(widget.data['title'], style: AppTextStyle.heading),
                TextHtmlWidget(htmlData: widget.data['description'] ?? ''),
              ],
            ),
          ),
        ),
